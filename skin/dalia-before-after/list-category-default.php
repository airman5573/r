	...
	<?php if($board->initCategory1()):?>
		<ul class="kboard-category-list">
			...
			<li	<?php if(kboard_category1() == $board->currentCategory()):?> class="kboard-category-selected"<?php endif?>>
				<a href="<?php echo $url->set('category1', $board->currentCategory())->set('pageid', '1')->set('target', '')->set('keyword', '')->set('mod', 'list')->toString()?>"><?php echo $board->currentCategory()?> <span class="amount">(48)</span></a>
			</li>
			<?php endwhile?>
		</ul>
	<?php endif?>
	...
	<?php if($board->initCategory2()):?>
		<ul class="kboard-category-list">
			...
			<li	<?php if(kboard_category2() == $board->currentCategory()):?> class="kboard-category-selected"<?php endif?>>
				<a href="<?php echo $url->set('category2', $board->currentCategory())->set('pageid', '1')->set('target', '')->set('keyword', '')->set('mod', 'list')->toString()?>"><?php echo $board->currentCategory()?> <span class="amount">(48)</span></a>
			</li>
			<?php endwhile?>
		</ul>
	<?php endif?>
