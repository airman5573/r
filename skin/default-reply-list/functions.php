...
// Care Program Sync -- Start
add_action('kboard_document_insert_21', 'dalia_review_sync_care_program_when_insert', 11, 4);
function dalia_review_sync_care_program_when_insert($content_uid, $board_id, $content, $board) {
    dalia_sync_careprogram($content);
}

add_action('kboard_document_update', 'dalia_review_sync_care_program_when_update', 11, 3);
function dalia_review_sync_care_program_when_update($content_uid, $board_id, $board) {
    if ($board_id !== 21) {
        return;
    }
