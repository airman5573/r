<div id="kboard-document">
    <div id="kboard-hwaikeul-gallery-document">
    	<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
			<span class="category-bullet">배우/탤런트</span>
		...
		<div class="kboard-control">
			...
			<div class="right">
				<a href="<?php echo $url->getContentEditor($content->uid)?>" class="kboard-hwaikeul-gallery-button-small dalia-btn-01"><span class="button-text text-edit"><?php echo __('Edit', 'kboard')?></span></a>
				<a href="<?php echo $url->getContentRemove($content->uid)?>" class="kboard-hwaikeul-gallery-button-small dalia-btn-01" onclick="return confirm('<?php echo __('Are you sure you want to delete?', 'kboard')?>');"><span class="button-text text-delete"><?php echo __('Delete', 'kboard')?></span></a>
			</div>
			<?php endif?>
		</div>
