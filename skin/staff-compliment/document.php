				...
				<div class="kboard-detail document-header-bottom">
					...
					<div class="detail-attr detail-category2">
						<div class="detail-name">
							<select id="kboard-select-category2" name="category2" onchange="kboard_staff_compliment_category_update('<?php echo $content->uid?>', this.value)">
		...
		<div class="kboard-control">
			<div class="left">
				...
				<!-- <?php if($board->isReply() && !$content->notice):?>
					<a href="<?php echo $url->set('parent_uid', $content->uid)->set('mod', 'editor')->toString()?>" class="kboard-staff-compliment-button-gray dalia-btn-01"><?php echo __('Reply', 'kboard')?></a>
				<?php endif?> -->
			</div>
...
<?php wp_enqueue_script('staff-compliment-document', "{$skin_path}/document.js", array(), KBOARD_VERSION, true)?>