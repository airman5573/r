	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td class="kboard-list-status text-center">
						<?php
				...
				<td class="kboard-list-user text-center"><?php echo apply_filters('kboard_user_display', $content->getUserName(), $content->getUserID(), $content->getUserName(), 'kboard', $boardBuilder)?></td>
