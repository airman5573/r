            ...
            <div class="document-header">
                ...
                <div class="kboard-detail document-header-bottom">
                    ...
                    <div class="detail-attr">
                        ...
                        <div class="detail-value"><?php echo dalia_qna_kboard_get_username($content, $boardBuilder); ?></div>
                    </div>
                    <div class="detail-attr">
                        <div class="detail-name">이메일 :</div>
                        <div class="detail-value"><?php echo dalia_qna_kboard_get_email($content); ?></div>
                    </div>
                    <div class="detail-attr">
                        <div class="detail-name">휴대폰번호 :</div>
                        <div class="detail-value"><?php echo dalia_qna_kboard_get_tel($content); ?></div>
                    </div>
                    <div class="detail-attr">
                        <div class="detail-name">통보방법 :</div>
                        <div class="detail-value"><?php echo dalia_qna_kboard_get_notify_method($content); ?></div>
                    </div>
