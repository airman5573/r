<div id="kboard-document">
	<div id="kboard-qna-document">
				...
				<div class="kboard-detail document-header-bottom">
					...
					<div class="detail-attr detail-category2">
						<div class="detail-name">
							<select id="kboard-select-category2" name="category2" onchange="kboard_qna_category_update('<?php echo $content->uid?>', this.value)">
					...
					<div class="detail-attr">
						...
						<div class="detail-value">
							<?php echo $content->option->{'65fbeceba6ddb'}?>
						</div>
					</div>
					<div class="detail-attr">
						<div class="detail-name">휴대폰번호 :</div>
						<div class="detail-value"><?php echo $content->option->{'65fbecfba6ddc'}?></div>
					</div>
					<!-- 통보방법 셀렉터 -->
					<div class="detail-attr">
						<div class="detail-name">통보방법 :</div>
						<div class="detail-value">이메일</div>
					</div>
		...
		<div class="kboard-document-navi">
			<div class="kboard-prev-document">
				...
				<a href="<?php echo $url->getDocumentURLWithUID($bottom_content_uid)?>">
					...
					<span class="navi-document-title kboard-qna-cut-strings"><?php echo $bottom_content->title?></span>
				</a>
				<?php endif?>
			</div>
			...
			<div class="kboard-next-document">
				...
				<a href="<?php echo $url->getDocumentURLWithUID($top_content_uid)?>">
					<span class="navi-document-title kboard-qna-cut-strings"><?php echo $top_content->title?></span>
		...
		<div class="kboard-control">
			<div class="left">
				<a href="<?php echo $url->getBoardList()?>" class="kboard-qna-button-gray dalia-btn-01"><?php echo __('List', 'kboard')?></a>
				<!-- <?php if($board->isReply() && !$content->notice):?>
					<a href="<?php echo $url->set('parent_uid', $content->uid)->set('mod', 'editor')->toString()?>" class="kboard-qna-button-gray dalia-btn-01"><?php echo __('Reply', 'kboard')?></a>
				<?php endif?> -->
			</div>
			<?php if($content->isEditor() || $board->permission_write=='all'):?>
			<div class="right">
				<a href="<?php echo $url->getContentEditor($content->uid)?>" class="kboard-qna-button-gray dalia-btn-01"><?php echo __('Edit', 'kboard')?></a>
				<a href="<?php echo $url->getContentRemove($content->uid)?>" class="kboard-qna-button-gray dalia-btn-01" onclick="return confirm('<?php echo __('Are you sure you want to delete?', 'kboard')?>');"><?php echo __('Delete', 'kboard')?></a>
			</div>
			<?php endif?>
		</div>
...
<?php wp_enqueue_script('qna-document', "{$skin_path}/document.js", array(), KBOARD_VERSION, true)?>