...
Plugin URI: https://www.cosmosfarm.com/wpstore/product/revew-latest-latest
...
if(!function_exists('video_gallery_slider')){
	function video_gallery_slider($board, $is_latest=false){
		$classes = array();
