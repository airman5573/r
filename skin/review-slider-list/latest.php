<div class="slider-wrap">
    <div class="review-slider-list kboard-swiper  kboard-hwaikeul-video-slider-list">
        <ul class="swiper-wrapper kboard-list<?php if(review_slider_list($board)):?> <?php echo esc_attr(review_slider_list($board))?><?php endif?>">
            <li class="swiper-slide kboard-list-item<?php if($content->uid == kboard_uid()):?> kboard-list-selected<?php endif?>">
                <div class="item-padding">
                    <a href="<?php echo esc_url($url->getDocumentURLWithUID($content->uid))?>">
                        <div class="review-slider-thumbnail">
                            <?php if($content->option->youtube_id || $content->option->vimeo_id):?>
                                <div class="kboard-light-gallery">
                                        ...
                                        <?php if($content->getThumbnail(600, 338)):?>
                                            <div class="review-slider-container wide" style="background-image:url(<?php echo esc_url($content->getThumbnail(600, 338))?>)"></div>
                                        <?php elseif($content->option->youtube_id):?>
                                            <div class="review-slider-container wide" style="background-image:url(<?php echo esc_url($content->option->youtube_thumbnail_url):?>)"></div>
                                        <?php elseif($content->option->vimeo_id):?>
                                            <div class="review-slider-container wide" style="background-image:url(<?php echo esc_url($content->option->vimeo_thumbnail_url):?>)"></div>
                                        <?php endif?>
                                
                                </div>
                                <!-- <div class="review-slider-foreground"></div>
                                <div class="review-slider-foreground-search"></div> -->
                            <?php elseif(count((array)$content->getAttachmentList()) > 0): $count = 0?>
                                <?php foreach($content->getAttachmentList() as $key=>$attach): $extension = strtolower(pathinfo($attach[0], PATHINFO_EXTENSION));?>
                                    <?php if(in_array($extension, array('mp4')) && $count == 0): $count++?>
                                        ...
                                        <div class="kboard-light-gallery">
                                            <div class="review-slider-container wide target-video" style="background-image:url(<?php echo esc_url($content->getThumbnail(600, 338))?>)" data-poster="<?php echo esc_url($content->getThumbnail(600, 338))?>" data-html="#video-<?php echo $content->uid?>-<?php echo $key?>" ></div>
                                        </div>
                                        <!-- <div class="review-slider-foreground"></div>
                                        <div class="review-slider-foreground-search"></div> -->
                                    <?php endif?>
                                ...
                                <?php else:?>
                                    <!-- <a href="<?php echo esc_url($url->getDocumentURLWithUID($content->uid))?>"> -->
                                        <?php if($content->getThumbnail(600, 338)):?>
                                            <div class="review-slider-container wide" style="background-image:url(<?php echo esc_url($content->getThumbnail(600, 338))?>)"></div>
                                        <?php else:?>
                                            <div class="review-slider-container wide no-image"></div>
                                        <?php endif?>
                                        <!-- <div class="review-slider-foreground"></div>
                                        <div class="review-slider-foreground-search"></div> -->
                                    <!-- </a> -->
                        ...
                        <div class="review-slider-wrap">
                            ...
                            <?php
                                ...
                                ?>
                                <?php if($info_value):?>
                                <div class="review-slider-info review-slider-cut-strings">
                                    <?php echo implode('<span class="kboard-info-separator">ㆍ</span>', $info_value);?>
                                    <?php if($content->isNew()):?><span class="review-slider-new-notify new-mark">N</span><?php endif?>
                                </div>
                            <?php endif?>
                                <div class="review-slider-title gallery-title">
...
wp_enqueue_script('review-slider-list', "{$skin_path}/script.js", array(), '1.0', true);
?>