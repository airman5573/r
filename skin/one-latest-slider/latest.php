<div class="slider-wrap">
	<div class="one-latest-slider-list kboard-swiper">
				...
				<li class="swiper-slide kboard-list-item<?php if($content->uid == kboard_uid()):?> kboard-list-selected<?php endif?>">
					<div class="item-padding">
						<a href="<?php echo esc_url($url->getDocumentURLWithUID($content->uid))?>">
							<div class="one-latest-slider-thumbnail">
								<?php if($content->getThumbnail(600, 338)):?>
									<div class="one-latest-slider-container wide" style="background-image:url(<?php echo esc_url($content->getThumbnail(600, 338))?>)"></div>
								<?php else:?>
									<div class="one-latest-slider-container wide no-image"></div>
								<?php endif?>
							</div>
...
wp_enqueue_script('one-latest-slider-latestview-slider', "{$skin_path}/script.js", array(), '1.0', true);
?>