<div id="kboard-hompage-review-editor" class="confirm">
	<form method="post" action="<?php echo esc_url($url->getConfirmExecute($content->uid))?>">
		...
		<div class="kboard-control">
			<div class="left">
				...
				<a href="<?php echo esc_url($url->getDocumentURLWithUID($content->uid))?>" class="kboard-hompage-review-button-small dalia-btn-01"><span class="button-text text-document"><?php echo __('Document', 'kboard')?></span></a>
				<?php endif?>
			...
			<div class="right">
				<button type="submit" class="kboard-hompage-review-button-small dalia-btn-01"><span class="button-text text-confirm"><?php echo __('Password confirm', 'kboard')?></span></button>
			</div>
		</div>
	</form>
</div>