<div id="kboard-hwaikeul-video-latest" class="kboard-hwaikeul-video-latest<?php if(revew_latest_list($board, true)):?> <?php echo esc_attr(revew_latest_list($board, true))?><?php endif?>">
