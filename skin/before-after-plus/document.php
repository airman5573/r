<div id="kboard-document">
	<div id="kboard-before-after-plus-document">
		<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
			...
			<div class="kboard-thumbnail">
				...
				<div class="kboard-thumbnail-toggle">
					<?php if(!kboard_before_after_plus_image_check($content, 'front_before_image') && !kboard_before_after_plus_image_check($content, 'front_after_image')):?><input type="button" id="front-toggle" class="hide">
					<?php else:?><input type="button" class="front-toggle <?php if(kboard_before_after_plus_first_image($content) == 'front'):?>selected<?php endif?>" onclick="kboard_before_after_plus_document_img_toggle('front')" value="정면">
					<?php endif?>
					<?php if(!kboard_before_after_plus_image_check($content, 'half_side_before_image') && !kboard_before_after_plus_image_check($content, 'half_side_after_image')):?><input type="button" id="half-side-toggle" class="hide">
					<?php else:?><input type="button" class="half-side-toggle <?php if(kboard_before_after_plus_first_image($content) == 'half-side'):?>selected<?php endif?>" onclick="kboard_before_after_plus_document_img_toggle('half_side')" value="반측면">
					<?php endif?>
					<?php if(!kboard_before_after_plus_image_check($content, 'side_before_image') && !kboard_before_after_plus_image_check($content, 'side_after_image')):?><input type="button" id="side-toggle" class="hide">
					<?php else:?><input type="button" class="side-toggle <?php if(kboard_before_after_plus_first_image($content) == 'side'):?>selected<?php endif?>" onclick="kboard_before_after_plus_document_img_toggle('side')" value="측면">
					<?php endif?>
				</div>
			</div>
		...
		<div class="kboard-control">
			<div class="left">
				<a href="<?php echo $url->set('mod', 'list')->toString()?>" class="kboard-before-after-plus-button-small"><?php echo __('List', 'kboard')?></a>
			</div>
			<?php if($board->isEditor($content->member_uid) || $board->permission_write=='all'):?>
			<div class="right">
				<a href="<?php echo esc_url($url->getContentEditor($content->uid))?>" class="kboard-before-after-plus-button-small"><?php echo __('Edit', 'kboard')?></a>
				<a href="<?php echo esc_url($url->getContentRemove($content->uid))?>" class="kboard-before-after-plus-button-small" onclick="return confirm('<?php echo __('Are you sure you want to delete?', 'kboard')?>');"><?php echo __('Delete', 'kboard')?></a>
			</div>
			<?php endif?>
		</div>
