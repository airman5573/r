...
<head>
	...
	<style>
	* { font-family: Pretendard, Malgun Gothic,arial,sans-serif,arial,sans-serif; }
	html,body { margin: 0; padding: 0; background-color: white; }
	img { border: 0; }
	a.upload-button {
		cursor: pointer;
	}
	.kboard-media-header { padding: 0 20px; font-size: 20px; overflow: hidden; display: flex; align-items: center; justify-content: space-between;}
	...
	.kboard-media-header .header-button { display: inline-block; *display: inline; zoom: 1; vertical-align: middle; margin: 0; padding: 0; padding: 0 10px; line-height: 40px; border: 0; color: #757575; cursor: pointer; text-decoration: none; font-size: 20px;}
	.kboard-media-header .header-button img { vertical-align: middle; width: 100%; height: 100%; max-width: 20px; object-fit: cover;}
	.media-wrap { padding: 0 10px; overflow: hidden; }
	.media-wrap .no-media { margin: 20px 10px; padding: 30px 10px; overflow: hidden; line-height: 30px; border: 1px solid #eeeeee; color: #757575; text-align: center; }
...
<form id="kboard-media-form" enctype="multipart/form-data" method="post" onsubmit="return kboard_media_form_execute(this)" data-allow="gif|jpg|jpeg|png|pjp|pjpeg|jfif|svg|bmp|webp|ico">
	...
	<div class="kboard-media-header">
		...
		<a href="javascript:void(0)" class="header-button" onclick="kboard_media_close();return false;" title="<?php echo __('창닫기', 'kboard')?>"><i class="xi-close"></i></a>
	</div>
</form>
